    ...
    <div class="wrap">
        ...
        <form method="post" action="">
            ...
            <table class="form-table">
                ...
                <tr>
                    <th scope="row"><label for="direktt_review_min_rating">Minimum Rating</label></th>
                    <td>
                ...
                <tr>
                    <th scope="row"><label for="direktt_review_max_rating">Maximum Rating</label></th>
                    <td>
                ...
                <tr>
                    <th scope="row"><label for="direktt_review_threshold">Threshold Rating</label></th>
                    <td>
                        ...
                        <p class="description">If rating is below this threshold, the under threshold template will be used.</p>
                        <p class="description">If rating is above this threshold, the over threshold template will be used.</p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="direktt_review_under_threshold_template">Under Threshold Template</label></th>
                    <td>
                ...
                <tr>
                    <th scope="row"><label for="direktt_review_over_threshold_template">Over Threshold Template</label></th>
                    <td>
        ...
        <div class="direktt-reviews-list">
            ...
            if ( is_array( $reviews ) && ! empty( $reviews ) ) {
                ...
                foreach ( $reviews as $review ) {
                    ...
                    echo '<li>' . esc_html( $date ) . ' - Rating: ' . esc_html( $rating ) . '</li>';
                }
                echo '</ul>';
            } else {
...
function on_submit_review( $request ) {
    if ( array_key_exists( 'rating', $request ) ) {
        ...
        wp_send_json_error(new WP_Error('Missing paramet', 'Subscription Id or Rating is missing'), 400);
    }
}
